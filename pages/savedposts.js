    ...
    <section className="text-gray-600 body-font my-4 min-h-screen">
      ...
      <div className="container px-5 py-24 mx-auto flex flex-wrap">
        <div className="flex w-full mb-20 flex-wrap">
          ...
          <p className="lg:pl-6 lg:w-2/3 mx-auto leading-relaxed text-base">Find more content which suits you, save other posts and help us to suggest to content liked you. Some posts that are saved by you are below.</p>
        </div>
