            ...
            <main className='md:w-[90%] lg:w-[80%] max-w-[1400px] md:m-auto px-6 md:px-0 flex space-y-2 sm:space-y-0 flex-col sm:flex-row justify-between items-center py-3 '>
                ...
                <nav className="nav">
                    {token ?
                        ...
                        :
                        <ul className='flex space-x-3 items-center justify-evenly'>
                            <Link href={'/login'}>
                                <a className='mx-2 text-black py-1 px-3 hover:text-white hover:bg-gray-700 border-2 border-black rounded-md text-sm sm:block hidden'>Login</a>
                            </Link>
                            <Link href={'/signup'}>
                                <a className='mx-2 text-black py-1 px-3 hover:text-white hover:bg-gray-700 border-2 border-black rounded-md text-sm sm:block hidden' onClick={() => { setEditDetails(true) }}>SignUp</a>
                            </Link>
                        </ul>
                    }
